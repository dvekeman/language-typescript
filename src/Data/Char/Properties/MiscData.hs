...
isBidiControl i
  | (i >= '\x200E') && (i <= '\x200F') = True
isBidiControl i
  | (i >= '\x202A') && (i <= '\x202E') = True
...
isTerminalPunctuation i
  | (i >= '\x003A') && (i <= '\x003B') = True
...
isTerminalPunctuation i
  | (i >= '\x0700') && (i <= '\x070A') = True
isTerminalPunctuation '\x070C' = True
isTerminalPunctuation i
  | (i >= '\x0964') && (i <= '\x0965') = True
isTerminalPunctuation i
  | (i >= '\x0E5A') && (i <= '\x0E5B') = True
isTerminalPunctuation i
  | (i >= '\x104A') && (i <= '\x104B') = True
isTerminalPunctuation i
  | (i >= '\x1361') && (i <= '\x1368') = True
isTerminalPunctuation i
  | (i >= '\x166D') && (i <= '\x166E') = True
isTerminalPunctuation i
  | (i >= '\x16EB') && (i <= '\x16ED') = True
isTerminalPunctuation i
  | (i >= '\x17D4') && (i <= '\x17D6') = True
isTerminalPunctuation '\x17DA' = True
isTerminalPunctuation i
  | (i >= '\x1802') && (i <= '\x1805') = True
isTerminalPunctuation i
  | (i >= '\x1808') && (i <= '\x1809') = True
isTerminalPunctuation i
  | (i >= '\x203C') && (i <= '\x203D') = True
isTerminalPunctuation i
  | (i >= '\x2048') && (i <= '\x2049') = True
isTerminalPunctuation i
  | (i >= '\x3001') && (i <= '\x3002') = True
isTerminalPunctuation i
  | (i >= '\xFE50') && (i <= '\xFE52') = True
isTerminalPunctuation i
  | (i >= '\xFE54') && (i <= '\xFE57') = True
isTerminalPunctuation '\xFF01' = True
isTerminalPunctuation '\xFF0C' = True
isTerminalPunctuation '\xFF0E' = True
isTerminalPunctuation i
  | (i >= '\xFF1A') && (i <= '\xFF1B') = True
...
isOtherMath i
  | (i >= '\x1D400') && (i <= '\x1D454') = True
isOtherMath i
  | (i >= '\x1D456') && (i <= '\x1D49C') = True
isOtherMath i
  | (i >= '\x1D49E') && (i <= '\x1D49F') = True
isOtherMath '\x1D4A2' = True
isOtherMath i
  | (i >= '\x1D4A5') && (i <= '\x1D4A6') = True
isOtherMath i
  | (i >= '\x1D4A9') && (i <= '\x1D4AC') = True
isOtherMath i
  | (i >= '\x1D4AE') && (i <= '\x1D4B9') = True
isOtherMath '\x1D4BB' = True
isOtherMath i
  | (i >= '\x1D4BD') && (i <= '\x1D4C0') = True
isOtherMath i
  | (i >= '\x1D4C2') && (i <= '\x1D4C3') = True
isOtherMath i
  | (i >= '\x1D4C5') && (i <= '\x1D505') = True
isOtherMath i
  | (i >= '\x1D507') && (i <= '\x1D50A') = True
isOtherMath i
  | (i >= '\x1D50D') && (i <= '\x1D514') = True
isOtherMath i
  | (i >= '\x1D516') && (i <= '\x1D51C') = True
isOtherMath i
  | (i >= '\x1D51E') && (i <= '\x1D539') = True
isOtherMath i
  | (i >= '\x1D53B') && (i <= '\x1D53E') = True
isOtherMath i
  | (i >= '\x1D540') && (i <= '\x1D544') = True
isOtherMath '\x1D546' = True
isOtherMath i
  | (i >= '\x1D54A') && (i <= '\x1D550') = True
isOtherMath i
  | (i >= '\x1D552') && (i <= '\x1D6A3') = True
isOtherMath i
  | (i >= '\x1D6A8') && (i <= '\x1D6C0') = True
isOtherMath i
  | (i >= '\x1D6C2') && (i <= '\x1D6DA') = True
isOtherMath i
  | (i >= '\x1D6DC') && (i <= '\x1D6FA') = True
isOtherMath i
  | (i >= '\x1D6FC') && (i <= '\x1D714') = True
isOtherMath i
  | (i >= '\x1D716') && (i <= '\x1D734') = True
isOtherMath i
  | (i >= '\x1D736') && (i <= '\x1D74E') = True
isOtherMath i
  | (i >= '\x1D750') && (i <= '\x1D76E') = True
isOtherMath i
  | (i >= '\x1D770') && (i <= '\x1D788') = True
isOtherMath i
  | (i >= '\x1D78A') && (i <= '\x1D7A8') = True
isOtherMath i
  | (i >= '\x1D7AA') && (i <= '\x1D7C2') = True
isOtherMath i
  | (i >= '\x1D7C4') && (i <= '\x1D7C9') = True
isOtherMath i
  | (i >= '\x1D7CE') && (i <= '\x1D7FF') = True
isOtherMath _ = False
        -- | Characters commonly used for the representation of hexadecimal numbers, plus their compatibility equivalents.

isHexDigit :: Char -> Bool
isHexDigit i
  | (i >= '\x0030') && (i <= '\x0039') = True
isHexDigit i
  | (i >= '\x0041') && (i <= '\x0046') = True
isHexDigit i
  | (i >= '\x0061') && (i <= '\x0066') = True
isHexDigit i
  | (i >= '\xFF10') && (i <= '\xFF19') = True
isHexDigit i
  | (i >= '\xFF21') && (i <= '\xFF26') = True
isHexDigit i
  | (i >= '\xFF41') && (i <= '\xFF46') = True
isHexDigit _ = False
...
isOtherAlphabetic i
  | (i >= '\x05B0') && (i <= '\x05B9') = True
isOtherAlphabetic i
  | (i >= '\x05BB') && (i <= '\x05BD') = True
isOtherAlphabetic '\x05BF' = True
isOtherAlphabetic i
  | (i >= '\x05C1') && (i <= '\x05C2') = True
isOtherAlphabetic '\x05C4' = True
isOtherAlphabetic i
  | (i >= '\x064B') && (i <= '\x0655') = True
isOtherAlphabetic '\x0670' = True
isOtherAlphabetic i
  | (i >= '\x06D6') && (i <= '\x06DC') = True
isOtherAlphabetic i
  | (i >= '\x06E1') && (i <= '\x06E4') = True
isOtherAlphabetic i
  | (i >= '\x06E7') && (i <= '\x06E8') = True
isOtherAlphabetic '\x06ED' = True
isOtherAlphabetic '\x0711' = True
isOtherAlphabetic i
  | (i >= '\x0730') && (i <= '\x073F') = True
isOtherAlphabetic i
  | (i >= '\x07A6') && (i <= '\x07B0') = True
isOtherAlphabetic i
  | (i >= '\x0901') && (i <= '\x0902') = True
isOtherAlphabetic '\x0903' = True
isOtherAlphabetic i
  | (i >= '\x093E') && (i <= '\x0940') = True
isOtherAlphabetic i
  | (i >= '\x0941') && (i <= '\x0948') = True
isOtherAlphabetic i
  | (i >= '\x0949') && (i <= '\x094C') = True
isOtherAlphabetic i
  | (i >= '\x0962') && (i <= '\x0963') = True
isOtherAlphabetic '\x0981' = True
isOtherAlphabetic i
  | (i >= '\x0982') && (i <= '\x0983') = True
isOtherAlphabetic i
  | (i >= '\x09BE') && (i <= '\x09C0') = True
isOtherAlphabetic i
  | (i >= '\x09C1') && (i <= '\x09C4') = True
isOtherAlphabetic i
  | (i >= '\x09C7') && (i <= '\x09C8') = True
isOtherAlphabetic i
  | (i >= '\x09CB') && (i <= '\x09CC') = True
isOtherAlphabetic '\x09D7' = True
isOtherAlphabetic i
  | (i >= '\x09E2') && (i <= '\x09E3') = True
isOtherAlphabetic '\x0A02' = True
isOtherAlphabetic i
  | (i >= '\x0A3E') && (i <= '\x0A40') = True
isOtherAlphabetic i
  | (i >= '\x0A41') && (i <= '\x0A42') = True
isOtherAlphabetic i
  | (i >= '\x0A47') && (i <= '\x0A48') = True
isOtherAlphabetic i
  | (i >= '\x0A4B') && (i <= '\x0A4C') = True
isOtherAlphabetic i
  | (i >= '\x0A70') && (i <= '\x0A71') = True
isOtherAlphabetic i
  | (i >= '\x0A81') && (i <= '\x0A82') = True
isOtherAlphabetic '\x0A83' = True
isOtherAlphabetic i
  | (i >= '\x0ABE') && (i <= '\x0AC0') = True
isOtherAlphabetic i
  | (i >= '\x0AC1') && (i <= '\x0AC5') = True
isOtherAlphabetic i
  | (i >= '\x0AC7') && (i <= '\x0AC8') = True
isOtherAlphabetic '\x0AC9' = True
isOtherAlphabetic i
  | (i >= '\x0ACB') && (i <= '\x0ACC') = True
isOtherAlphabetic '\x0B01' = True
isOtherAlphabetic i
  | (i >= '\x0B02') && (i <= '\x0B03') = True
isOtherAlphabetic '\x0B3E' = True
isOtherAlphabetic '\x0B3F' = True
isOtherAlphabetic '\x0B40' = True
isOtherAlphabetic i
  | (i >= '\x0B41') && (i <= '\x0B43') = True
isOtherAlphabetic i
  | (i >= '\x0B47') && (i <= '\x0B48') = True
isOtherAlphabetic i
  | (i >= '\x0B4B') && (i <= '\x0B4C') = True
isOtherAlphabetic '\x0B56' = True
isOtherAlphabetic '\x0B57' = True
isOtherAlphabetic '\x0B82' = True
isOtherAlphabetic i
  | (i >= '\x0BBE') && (i <= '\x0BBF') = True
isOtherAlphabetic '\x0BC0' = True
isOtherAlphabetic i
  | (i >= '\x0BC1') && (i <= '\x0BC2') = True
isOtherAlphabetic i
  | (i >= '\x0BC6') && (i <= '\x0BC8') = True
isOtherAlphabetic i
  | (i >= '\x0BCA') && (i <= '\x0BCC') = True
isOtherAlphabetic '\x0BD7' = True
isOtherAlphabetic i
  | (i >= '\x0C01') && (i <= '\x0C03') = True
isOtherAlphabetic i
  | (i >= '\x0C3E') && (i <= '\x0C40') = True
isOtherAlphabetic i
  | (i >= '\x0C41') && (i <= '\x0C44') = True
isOtherAlphabetic i
  | (i >= '\x0C46') && (i <= '\x0C48') = True
isOtherAlphabetic i
  | (i >= '\x0C4A') && (i <= '\x0C4C') = True
isOtherAlphabetic i
  | (i >= '\x0C55') && (i <= '\x0C56') = True
isOtherAlphabetic i
  | (i >= '\x0C82') && (i <= '\x0C83') = True
isOtherAlphabetic '\x0CBE' = True
isOtherAlphabetic '\x0CBF' = True
isOtherAlphabetic i
  | (i >= '\x0CC0') && (i <= '\x0CC4') = True
isOtherAlphabetic '\x0CC6' = True
isOtherAlphabetic i
  | (i >= '\x0CC7') && (i <= '\x0CC8') = True
isOtherAlphabetic i
  | (i >= '\x0CCA') && (i <= '\x0CCB') = True
isOtherAlphabetic '\x0CCC' = True
isOtherAlphabetic i
  | (i >= '\x0CD5') && (i <= '\x0CD6') = True
isOtherAlphabetic i
  | (i >= '\x0D02') && (i <= '\x0D03') = True
isOtherAlphabetic i
  | (i >= '\x0D3E') && (i <= '\x0D40') = True
isOtherAlphabetic i
  | (i >= '\x0D41') && (i <= '\x0D43') = True
isOtherAlphabetic i
  | (i >= '\x0D46') && (i <= '\x0D48') = True
isOtherAlphabetic i
  | (i >= '\x0D4A') && (i <= '\x0D4C') = True
isOtherAlphabetic '\x0D57' = True
isOtherAlphabetic i
  | (i >= '\x0D82') && (i <= '\x0D83') = True
isOtherAlphabetic i
  | (i >= '\x0DCF') && (i <= '\x0DD1') = True
isOtherAlphabetic i
  | (i >= '\x0DD2') && (i <= '\x0DD4') = True
isOtherAlphabetic '\x0DD6' = True
isOtherAlphabetic i
  | (i >= '\x0DD8') && (i <= '\x0DDF') = True
isOtherAlphabetic i
  | (i >= '\x0DF2') && (i <= '\x0DF3') = True
isOtherAlphabetic '\x0E31' = True
isOtherAlphabetic i
  | (i >= '\x0E34') && (i <= '\x0E3A') = True
isOtherAlphabetic '\x0E4D' = True
isOtherAlphabetic '\x0EB1' = True
isOtherAlphabetic i
  | (i >= '\x0EB4') && (i <= '\x0EB9') = True
isOtherAlphabetic i
  | (i >= '\x0EBB') && (i <= '\x0EBC') = True
isOtherAlphabetic '\x0ECD' = True
isOtherAlphabetic i
  | (i >= '\x0F71') && (i <= '\x0F7E') = True
isOtherAlphabetic '\x0F7F' = True
isOtherAlphabetic i
  | (i >= '\x0F80') && (i <= '\x0F81') = True
isOtherAlphabetic i
  | (i >= '\x0F90') && (i <= '\x0F97') = True
isOtherAlphabetic i
  | (i >= '\x0F99') && (i <= '\x0FBC') = True
isOtherAlphabetic '\x102C' = True
isOtherAlphabetic i
  | (i >= '\x102D') && (i <= '\x1030') = True
isOtherAlphabetic '\x1031' = True
isOtherAlphabetic '\x1032' = True
isOtherAlphabetic '\x1036' = True
isOtherAlphabetic '\x1038' = True
isOtherAlphabetic i
  | (i >= '\x1056') && (i <= '\x1057') = True
isOtherAlphabetic i
  | (i >= '\x1058') && (i <= '\x1059') = True
isOtherAlphabetic i
  | (i >= '\x16EE') && (i <= '\x16F0') = True
isOtherAlphabetic i
  | (i >= '\x1712') && (i <= '\x1713') = True
isOtherAlphabetic i
  | (i >= '\x1732') && (i <= '\x1733') = True
isOtherAlphabetic i
  | (i >= '\x1752') && (i <= '\x1753') = True
isOtherAlphabetic i
  | (i >= '\x1772') && (i <= '\x1773') = True
isOtherAlphabetic i
  | (i >= '\x17B4') && (i <= '\x17B6') = True
isOtherAlphabetic i
  | (i >= '\x17B7') && (i <= '\x17BD') = True
isOtherAlphabetic i
  | (i >= '\x17BE') && (i <= '\x17C5') = True
isOtherAlphabetic '\x17C6' = True
isOtherAlphabetic i
  | (i >= '\x17C7') && (i <= '\x17C8') = True
isOtherAlphabetic '\x18A9' = True
isOtherAlphabetic i
  | (i >= '\x2160') && (i <= '\x2183') = True
...
isIdeographic i
  | (i >= '\x3021') && (i <= '\x3029') = True
isIdeographic i
  | (i >= '\x3038') && (i <= '\x303A') = True
isIdeographic i
  | (i >= '\x3400') && (i <= '\x4DB5') = True
isIdeographic i
  | (i >= '\x4E00') && (i <= '\x9FA5') = True
isIdeographic i
  | (i >= '\xF900') && (i <= '\xFA2D') = True
isIdeographic i
  | (i >= '\x20000') && (i <= '\x2A6D6') = True
isIdeographic i
  | (i >= '\x2F800') && (i <= '\x2FA1D') = True
...
isDiacritic i
  | (i >= '\x02B0') && (i <= '\x02B8') = True
isDiacritic i
  | (i >= '\x02B9') && (i <= '\x02BA') = True
isDiacritic i
  | (i >= '\x02BB') && (i <= '\x02C1') = True
isDiacritic i
  | (i >= '\x02C2') && (i <= '\x02CF') = True
isDiacritic i
  | (i >= '\x02D0') && (i <= '\x02D1') = True
isDiacritic i
  | (i >= '\x02D2') && (i <= '\x02DF') = True
isDiacritic i
  | (i >= '\x02E0') && (i <= '\x02E4') = True
isDiacritic i
  | (i >= '\x02E5') && (i <= '\x02ED') = True
isDiacritic '\x02EE' = True
isDiacritic i
  | (i >= '\x0300') && (i <= '\x034E') = True
isDiacritic i
  | (i >= '\x0360') && (i <= '\x0362') = True
isDiacritic i
  | (i >= '\x0374') && (i <= '\x0375') = True
isDiacritic '\x037A' = True
isDiacritic i
  | (i >= '\x0384') && (i <= '\x0385') = True
isDiacritic i
  | (i >= '\x0483') && (i <= '\x0486') = True
isDiacritic '\x0559' = True
isDiacritic i
  | (i >= '\x0591') && (i <= '\x05A1') = True
isDiacritic i
  | (i >= '\x05A3') && (i <= '\x05B9') = True
isDiacritic i
  | (i >= '\x05BB') && (i <= '\x05BD') = True
...
isDiacritic i
  | (i >= '\x064B') && (i <= '\x0652') = True
isDiacritic i
  | (i >= '\x06DF') && (i <= '\x06E0') = True
isDiacritic i
  | (i >= '\x06E5') && (i <= '\x06E6') = True
isDiacritic i
  | (i >= '\x06EA') && (i <= '\x06EC') = True
isDiacritic i
  | (i >= '\x0730') && (i <= '\x074A') = True
isDiacritic i
  | (i >= '\x07A6') && (i <= '\x07B0') = True
isDiacritic '\x093C' = True
isDiacritic '\x094D' = True
isDiacritic i
  | (i >= '\x0951') && (i <= '\x0954') = True
...
isDiacritic i
  | (i >= '\x0E47') && (i <= '\x0E4C') = True
isDiacritic '\x0E4E' = True
isDiacritic i
  | (i >= '\x0EC8') && (i <= '\x0ECC') = True
isDiacritic i
  | (i >= '\x0F18') && (i <= '\x0F19') = True
isDiacritic '\x0F35' = True
isDiacritic '\x0F37' = True
isDiacritic '\x0F39' = True
isDiacritic i
  | (i >= '\x0F3E') && (i <= '\x0F3F') = True
isDiacritic i
  | (i >= '\x0F82') && (i <= '\x0F84') = True
isDiacritic i
  | (i >= '\x0F86') && (i <= '\x0F87') = True
isDiacritic '\x0FC6' = True
isDiacritic '\x1037' = True
isDiacritic '\x1039' = True
isDiacritic i
  | (i >= '\x17C9') && (i <= '\x17D3') = True
isDiacritic '\x1FBD' = True
isDiacritic i
  | (i >= '\x1FBF') && (i <= '\x1FC1') = True
isDiacritic i
  | (i >= '\x1FCD') && (i <= '\x1FCF') = True
isDiacritic i
  | (i >= '\x1FDD') && (i <= '\x1FDF') = True
isDiacritic i
  | (i >= '\x1FED') && (i <= '\x1FEF') = True
isDiacritic i
  | (i >= '\x1FFD') && (i <= '\x1FFE') = True
isDiacritic i
  | (i >= '\x302A') && (i <= '\x302F') = True
isDiacritic i
  | (i >= '\x3099') && (i <= '\x309A') = True
isDiacritic i
  | (i >= '\x309B') && (i <= '\x309C') = True
isDiacritic '\x30FC' = True
isDiacritic '\xFB1E' = True
isDiacritic i
  | (i >= '\xFE20') && (i <= '\xFE23') = True
isDiacritic '\xFF3E' = True
isDiacritic '\xFF40' = True
isDiacritic '\xFF70' = True
isDiacritic i
  | (i >= '\xFF9E') && (i <= '\xFF9F') = True
isDiacritic '\xFFE3' = True
isDiacritic i
  | (i >= '\x1D167') && (i <= '\x1D169') = True
isDiacritic i
  | (i >= '\x1D16D') && (i <= '\x1D172') = True
isDiacritic i
  | (i >= '\x1D17B') && (i <= '\x1D182') = True
isDiacritic i
  | (i >= '\x1D185') && (i <= '\x1D18B') = True
isDiacritic i
  | (i >= '\x1D1AA') && (i <= '\x1D1AD') = True
isDiacritic _ = False
...
isExtender i
  | (i >= '\x3031') && (i <= '\x3035') = True
isExtender i
  | (i >= '\x309D') && (i <= '\x309E') = True
isExtender i
  | (i >= '\x30FC') && (i <= '\x30FE') = True
...
isNoncharacterCodePoint i
  | (i >= '\xFDD0') && (i <= '\xFDEF') = True
isNoncharacterCodePoint i
  | (i >= '\xFFFE') && (i <= '\xFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x1FFFE') && (i <= '\x1FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x2FFFE') && (i <= '\x2FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x3FFFE') && (i <= '\x3FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x4FFFE') && (i <= '\x4FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x5FFFE') && (i <= '\x5FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x6FFFE') && (i <= '\x6FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x7FFFE') && (i <= '\x7FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x8FFFE') && (i <= '\x8FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x9FFFE') && (i <= '\x9FFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xAFFFE') && (i <= '\xAFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xBFFFE') && (i <= '\xBFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xCFFFE') && (i <= '\xCFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xDFFFE') && (i <= '\xDFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xEFFFE') && (i <= '\xEFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\xFFFFE') && (i <= '\xFFFFF') = True
isNoncharacterCodePoint i
  | (i >= '\x10FFFE') && (i <= '\x10FFFF') = True
isNoncharacterCodePoint _ = False
        -- | Used in deriving  the Grapheme_Extend property.

isOtherGraphemeExtend :: Char -> Bool
isOtherGraphemeExtend i
  | (i >= '\xFF9E') && (i <= '\xFF9F') = True
...
isIDSBinaryOperator i
  | (i >= '\x2FF0') && (i <= '\x2FF1') = True
isIDSBinaryOperator i
  | (i >= '\x2FF4') && (i <= '\x2FFB') = True
isIDSBinaryOperator _ = False
        -- | For a machine-readable list of Ideographic Description Sequences.  For more information, see Unicode 3.2.

isIDSTrinaryOperator :: Char -> Bool
isIDSTrinaryOperator i
  | (i >= '\x2FF2') && (i <= '\x2FF3') = True
isIDSTrinaryOperator _ = False
        -- | For a machine-readable list of Ideographic Description Sequences.  For more information, see Unicode 3.2.

isRadical :: Char -> Bool
isRadical i
  | (i >= '\x2E80') && (i <= '\x2E99') = True
isRadical i
  | (i >= '\x2E9B') && (i <= '\x2EF3') = True
isRadical i
  | (i >= '\x2F00') && (i <= '\x2FD5') = True
isRadical _ = False
        -- | For a machine-readable list of Ideographic Description Sequences.  For more information, see Unicode 3.2.

isUnifiedIdeograph :: Char -> Bool
isUnifiedIdeograph i
  | (i >= '\x3400') && (i <= '\x4DB5') = True
isUnifiedIdeograph i
  | (i >= '\x4E00') && (i <= '\x9FA5') = True
isUnifiedIdeograph i
  | (i >= '\xFA0E') && (i <= '\xFA0F') = True
isUnifiedIdeograph '\xFA11' = True
isUnifiedIdeograph i
  | (i >= '\xFA13') && (i <= '\xFA14') = True
isUnifiedIdeograph '\xFA1F' = True
isUnifiedIdeograph '\xFA21' = True
isUnifiedIdeograph i
  | (i >= '\xFA23') && (i <= '\xFA24') = True
isUnifiedIdeograph i
  | (i >= '\xFA27') && (i <= '\xFA29') = True
isUnifiedIdeograph i
  | (i >= '\x20000') && (i <= '\x2A6D6') = True
...
isOtherDefaultIgnorableCodePoint i
  | (i >= '\x180B') && (i <= '\x180D') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\x2060') && (i <= '\x2063') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\x2064') && (i <= '\x2069') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\x206A') && (i <= '\x206F') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xFE00') && (i <= '\xFE0F') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xFFF0') && (i <= '\xFFF8') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xFFF9') && (i <= '\xFFFB') = True
isOtherDefaultIgnorableCodePoint '\xE0000' = True
isOtherDefaultIgnorableCodePoint '\xE0001' = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xE0002') && (i <= '\xE001F') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xE0020') && (i <= '\xE007F') = True
isOtherDefaultIgnorableCodePoint i
  | (i >= '\xE0080') && (i <= '\xE0FFF') = True
...
isLogicalOrderException i
  | (i >= '\x0E40') && (i <= '\x0E44') = True
isLogicalOrderException i
  | (i >= '\x0EC0') && (i <= '\x0EC4') = True
